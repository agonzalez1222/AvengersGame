...
public class Monster extends Character
{
	...
	protected Monster(String name, String description, int attack, int healthPoints, Boolean isFrozen, int def)
	{
		super(healthPoints, attack, def);
		this.name = name;
	...
	Monster m1 = new Monster("Insane Crew Person","Crew member driven insane by the otherworldly happenings on the ship. It's as if they have seen the other side and come back changed. Their eyes...their eyes are so crazed. So....hollow...", (int)(Math.random() * 5 + 1), 10, false, 0);
	...
	Monster m4 = new Monster("Ghast", "A creature without a nose or forehead. It hops around looking for Gugs to eat on its hooved kangaroo-like legs, but will settle for anything meaty when necessary. The sounds it belches forth...the sounds burn into one's soul and will likely never leave, haunting one in this life and the next.", (int)(Math.random() * 5 + 9), 25, false, 0);
	Monster m5 = new Monster("Mi-go", "It seems to be made of an unknown substance resembling a fungus and has huge lobster claws and bat wings. What one assumes to be its mouth drips with a beautiful, pinkish substance. So lovely this substance.....it draws one to it. One just wants to touch it. Feel it. Swim in its beauty....", (int)(Math.random() * 3 + 11), 35, false, 0);
	Monster m6 = new Monster("Elder Thing", "A large starfish, with eyes and a mouth, sits atop a cylindrical mass of tentacles. Crab-like claws protrude hideous gaping maws that dot the writhing mass. One can hear it in their mind, speaking, praying, to some greater entity. Or maybe one is just going crazy. Yes...that must be it.", (int)(Math.random() * 6 + 10), 40, false, 0);
	...
	Monster boss = new Monster("Great Old One", "A horrifying, giant, three-eyed slug with metallic spines protruding from its slimy back and pyramid-shaped feet that scrape and screech against the metallic floor.", 30, 100, false, 0);
